...
public class FridgeItemResponse {
    ...
    public FridgeItemResponse(String userId, String name, String purchaseDate, String lastUpdated, Double quantity, String unitMeasurement, String imageFileName) {
        this.userId = userId;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        FridgeItemResponse that = (FridgeItemResponse) o;
