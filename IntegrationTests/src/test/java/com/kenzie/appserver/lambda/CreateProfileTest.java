...
public class CreateProfileTest {
    ...
    @Test
    public void createProfile_profileDoesNotExist_createsProfile() throws Exception {
    ...
    @Test
    public void createProfile_profileAlreadyExists_badRequest() throws Exception {
        String userId = mockNeat.users().valStr();
        String name = mockNeat.names().valStr();
        String email = mockNeat.emails().valStr();
        List<Diet> diets = Arrays.asList(Diet.GLUTEN_FREE);
